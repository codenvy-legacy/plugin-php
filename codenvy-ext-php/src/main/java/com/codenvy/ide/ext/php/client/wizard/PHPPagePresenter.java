...
public class PHPPagePresenter extends AbstractWizardPage implements PHPPageView.ActionDelegate {
    ...
    @Inject
    public PHPPagePresenter(PHPPageView view, ProjectServiceClient projectServiceClient, EventBus eventBus, DtoFactory dtoFactory,
                            DtoUnmarshallerFactory dtoUnmarshallerFactory) {
        super("PHP project settings", null);
        this.view = view;
